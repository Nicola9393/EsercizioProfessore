...
if (isset($_SESSION['user_id'])) {
    ...
    if ($profile == 'BACKOFFICE_AMM') {
        header('Location: admin/');
    } elseif ($profile == 'BACKOFFICE_ESE') {
        header('Location: esercizio/');
    } else {
    ...
    if (empty($email) || empty($password)) {
        ...
        if ($result->num_rows == 1) {
            ...
            if (md5($password) == $user['password']) {
                ...
                if ($user['profilo'] == 'BACKOFFICE_AMM') {
                    header('Location: admin/');
                } elseif ($user['profilo'] == 'BACKOFFICE_ESE') {
                    header('Location: esercizio/');
                } else {
                    header('Location: user/');
                }
...
<body>
    <div class="login-container">
        ...
        <div class="test-credentials">
            ...
            <p><strong>Utente registrato:</strong><br>
            Email: <code>mario.rossi@email.it</code><br>
            Password: <code>mario123</code></p>
            
            <p style="margin-top: 0.75rem;"><strong>Backoffice Amministrativo:</strong><br>
            Email: <code>admin@sft.it</code><br>
            Password: <code>admin123</code></p>
            
            <p style="margin-top: 0.75rem;"><strong>Backoffice Esercizio:</strong><br>
            Email: <code>esercizio@sft.it</code><br>
            Password: <code>esercizio123</code></p>
        </div>
    </div>
</body>
</html>